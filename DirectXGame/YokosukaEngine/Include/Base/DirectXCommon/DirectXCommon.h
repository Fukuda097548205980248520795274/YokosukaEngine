...
#include "../../PipelineStateObject/PostEffect/Scanline/Scanline.h"
...
private:
	...
	Microsoft::WRL::ComPtr<IDxcBlob> scanlinePixelShaderBlob_ = nullptr;
	...
	Microsoft::WRL::ComPtr<ID3D12Resource> scanlineResource_ = nullptr;
