#include "ParticleBlendNone.h"

/// <summary>
/// デストラクタ
/// </summary>
ParticleBlendNone::~ParticleBlendNone()
{
...
void ParticleBlendNone::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
