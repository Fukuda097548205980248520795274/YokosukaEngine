#include "ParticleBlendScreen.h"

/// <summary>
/// デストラクタ
/// </summary>
ParticleBlendScreen::~ParticleBlendScreen()
{
...
void ParticleBlendScreen::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
