#include "Line3dBlendScreen.h"

/// <summary>
/// デストラクタ
/// </summary>
Line3dBlendScreen::~Line3dBlendScreen()
{
...
void Line3dBlendScreen::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
