#include "Line3dBlendSubtract.h"

/// <summary>
/// デストラクタ
/// </summary>
Line3dBlendSubtract::~Line3dBlendSubtract()
{
...
void Line3dBlendSubtract::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
