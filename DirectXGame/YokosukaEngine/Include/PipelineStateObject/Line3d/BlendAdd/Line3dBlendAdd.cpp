#include "Line3dBlendAdd.h"

/// <summary>
/// デストラクタ
/// </summary>
Line3dBlendAdd::~Line3dBlendAdd()
{
...
void Line3dBlendAdd::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
