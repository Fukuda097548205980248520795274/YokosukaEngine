#include "PrimitiveBlendMultiply.h"

/// <summary>
/// デストラクタ
/// </summary>
PrimitiveBlendMultiply::~PrimitiveBlendMultiply()
{
...
void PrimitiveBlendMultiply::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
