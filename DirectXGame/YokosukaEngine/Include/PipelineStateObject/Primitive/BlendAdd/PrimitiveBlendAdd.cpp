#include "PrimitiveBlendAdd.h"

/// <summary>
/// デストラクタ
/// </summary>
PrimitiveBlendAdd::~PrimitiveBlendAdd()
{
...
void PrimitiveBlendAdd::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
