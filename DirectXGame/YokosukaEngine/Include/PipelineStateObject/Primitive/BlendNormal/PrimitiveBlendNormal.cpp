#include "PrimitiveBlendNormal.h"

/// <summary>
/// デストラクタ
/// </summary>
PrimitiveBlendNormal::~PrimitiveBlendNormal()
{
...
void PrimitiveBlendNormal::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
