#include "PrimitiveBlendScreen.h"

/// <summary>
/// デストラクタ
/// </summary>
PrimitiveBlendScreen::~PrimitiveBlendScreen()
{
...
void PrimitiveBlendScreen::Initialize(OutputLog* log, DirectXShaderCompiler* dxc, Microsoft::WRL::ComPtr<ID3D12Device> device)
{
	// nullptrチェック
	assert(dxc);
	assert(log);
