...
void EnemyBulletStar::Initialize(const YokosukaEngine* engine, const Camera3D* camera3d, const ModelHandleStore* modelHandleStore,
...
/// </summary>
/// <returns></returns>
Vector3 EnemyBulletStar::GetBulletWorldPosition() const
{
	// ワールド座標
