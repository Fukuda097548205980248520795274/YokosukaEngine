...
void EnemyBulletTrident::Initialize(const YokosukaEngine* engine, const Camera3D* camera3d, const ModelHandleStore* modelHandleStore,
	const Vector3& position)
{
	...
	// モデルハンドル
	bulletModelHandle_ = modelHandleStore_->GetModelHandle(ModelHandleStore::kEnemyBulletTrident)[0];
...
/// 更新処理
/// </summary>
void EnemyBulletTrident::Update()
{
	// 基底クラス更新
...
/// </summary>
/// <returns></returns>
Vector3 EnemyBulletTrident::GetBulletWorldPosition() const
{
	// ワールド座標
