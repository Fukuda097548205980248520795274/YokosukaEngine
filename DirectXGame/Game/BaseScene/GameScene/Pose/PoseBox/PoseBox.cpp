...
void PoseBox::Initialize(const YokosukaEngine* engine, const Camera2D* camera2d)
{
	// nullptrチェック
	assert(engine);
	assert(camera2d);
...
/// 開きのリセット
/// </summary>
void PoseBox::OpenReset(float time)
{
...
/// 閉じのリセット
/// </summary>
void PoseBox::CloseReset(float time)
{
