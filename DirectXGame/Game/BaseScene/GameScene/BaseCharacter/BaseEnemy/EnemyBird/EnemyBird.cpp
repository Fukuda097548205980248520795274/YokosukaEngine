...
/// </summary>
/// <returns></returns>
Vector3 EnemyBird::GetBodyWorldPosition() const
{
	// ワールド座標
...
/// </summary>
/// <returns></returns>
AABB EnemyBird::GetCollisionAABB() const
{
	// AABB
	AABB aabb;
...
void EnemyBird::OnCollision(const BasePlayerBullet* playerBullet)
{
	// 基底クラスの衝突判定応答
