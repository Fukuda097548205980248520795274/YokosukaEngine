#include "EnemyJetStateApproachingRear.h"
#include "../../EnemyJet.h"
...
EnemyJetStateApproachingRear::EnemyJetStateApproachingRear(EnemyJet* enemy)
...
/// 更新処理
/// </summary>
void EnemyJetStateApproachingRear::Update()
{
	// ワールドトランスフォームを取得する
	WorldTransform* worldTransform = enemy_->GetWorldTransform();
