#include "StageObjectBuildingA.h"
...
void StageObjectBuildingA::Initialize(const YokosukaEngine* engine, const Camera3D* camera3d, const ModelHandleStore* modelHandleStore, const float* gameFrame,
	float time, const Vector3& position, const Vector3& rotation)
{
	...
	// モデルを受け取る
	mhSaturnPlanet_ = modelHandleStore_->GetModelHandle(ModelHandleStore::kStageObjectBuildingA)[0];
}

/// <summary>
/// 更新処理
/// </summary>
void StageObjectBuildingA::Update()
{
	// 基底クラスの更新処理
...
/// 描画処理
/// </summary>
void StageObjectBuildingA::Draw()
{
	// モデルを描画する
