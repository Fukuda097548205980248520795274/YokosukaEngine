...
void StageObjectHouse::Initialize(const YokosukaEngine* engine, const Camera3D* camera3d, const ModelHandleStore* modelHandleStore, const float* gameFrame,
	float time, const Vector3& position, const Vector3& rotation)
{
	...
	// モデルを受け取る
	modelHandle_ = modelHandleStore_->GetModelHandle(ModelHandleStore::kStageObjectHouse)[0];
}

/// <summary>
/// 更新処理
/// </summary>
void StageObjectHouse::Update()
{
	// 基底クラスの更新処理
