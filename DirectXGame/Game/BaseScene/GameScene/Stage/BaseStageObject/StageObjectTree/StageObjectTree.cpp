...
void StageObjectTree::Initialize(const YokosukaEngine* engine, const Camera3D* camera3d, const ModelHandleStore* modelHandleStore, const float* gameFrame,
	float time, const Vector3& position, const Vector3& rotation)
{
	...
	// モデルを受け取る
	modelHandle_ = modelHandleStore_->GetModelHandle(ModelHandleStore::kStageObjectTree)[0];
}

/// <summary>
/// 更新処理
/// </summary>
void StageObjectTree::Update()
{
	// 基底クラスの更新処理
